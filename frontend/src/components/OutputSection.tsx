    ...
    >
      ...
      <textarea
        ...
        style={{
          ...
          resize: 'vertical', outline: 'none', marginBottom: '14px', lineHeight: '1.7',
        }}
      />
      <div className="font-mono text-[11px] text-muted-steel mb-5">
        Free TXT/MD exports include VantaCore attribution. Your content remains yours.
      </div>
